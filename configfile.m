...
% control noises
sigmaV= 0.3; % m/s
sigmaT= (3.0*pi/180); % radians
sigmaP= (3.0*pi/180); % radians
Q= [sigmaV^2 0 0; 0 sigmaT^2 0;  0 0 sigmaP^2];
...
GATE_REJECT= 6.0; % maximum distance for association
GATE_AUGMENT= 30.0; % minimum distance for creation of new feature
% For 2-D observation:
